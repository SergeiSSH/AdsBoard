...
from .views import PostList, PostDetail, CategoryDetail, SearchResultsListView, PostCreateView, PostUpdateView, PostDeleteView, CommentCreateView, CommentListView, CommentDeleteView, SearchCommentsResultsListView, comment_approved
